...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerHolder> {
    ...
    public interface OnViewClickListener {
        void onViewClickListener(View view, Object data, int position);
    }
    ...
    public abstract void refreshItem(BaseRecyclerHolder holder, T item, int position, List<Object> payloads, boolean isScrolling);
    ...
    public void onBindViewHolder(BaseRecyclerHolder holder, int position, List<Object> payloads) {
        if (payloads.isEmpty()){
            ...
            refreshItem(holder, getData(position), position, payloads, isScrolling);
        }
    }
    ...
    public void setViewOnClickListner(int viewId, int position, View.OnClickListener listener) {
