...
public class PartialView extends RelativeLayout {
    ...
    public void setFilledDrawable(Drawable drawable) {
        ...
        ClipDrawable clipDrawable = new ClipDrawable(drawable.getConstantState().newDrawable(),
    ...
    public void setStarHeightWidth(int height, int width) {
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                width == 0 ? RelativeLayout.LayoutParams.WRAP_CONTENT : width,
                height == 0 ? RelativeLayout.LayoutParams.WRAP_CONTENT : height);
